-- ============================================================
-- Quiz Trading Pro — VARIAÇÃO B — popup de captura
--
-- Rode DEPOIS do supabase-tracking-b.sql, no MESMO projeto da
-- variação B (gmfxivkgbldcngoarjtv). Aba nova no SQL Editor.
--
