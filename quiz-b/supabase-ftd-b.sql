-- ============================================================
-- Quiz Trading Pro — VARIAÇÃO B — depósitos (FTD)
--
-- Rode DEPOIS do supabase-tracking-b.sql e do supabase-popup-b.sql,
-- no MESMO projeto (gmfxivkgbldcngoarjtv). Aba nova no SQL Editor.
--
-- O QUE ISTO FAZ
