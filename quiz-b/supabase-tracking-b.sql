-- ============================================================
-- Quiz Trading Pro — VARIAÇÃO B — rastreamento
--
-- Rode no SQL Editor de um projeto Supabase NOVO, exclusivo desta
-- variação. Não use o projeto do quiz A: a ideia do teste é justamente
-- ter os dois números separados, sem chance de misturar.
-- ============================================================
...
create table if not exists quiz_eventos (
  ...
  variacao     text        not null default 'B',
