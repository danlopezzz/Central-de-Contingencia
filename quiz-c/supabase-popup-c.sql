-- ============================================================
-- Quiz Trading Pro — VARIAÇÃO C — popup de captura
--
-- Rode DEPOIS do supabase-tracking-c.sql, no MESMO projeto novo que
-- você criou para o quiz C. Aba nova no SQL Editor.
--
